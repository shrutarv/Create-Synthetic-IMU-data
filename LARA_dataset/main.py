...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    if usage_modus[usage_modus_idx] == 'train':
       ...
       folder_exp_base_fine_tuning = '/data/sawasthi/LaraMM/model/network_LaraMM_100.pth' #model_acc_up4.pth #model_up1_3a.pt
       '''
    ...
    '''
       ...
       folder_exp = '/data/sawasthi/mbientlab/model/jhmdb_LaraIMU_pose_ci_c1' + str(per_data) 
