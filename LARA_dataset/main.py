...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    batch_size_train = {
        ...
        'cnn_imu': {'mocap': 100, 'mbientlab': 100, 'virtual': 100, 'mocap_half': 100, 'virtual_quarter': 100,
                    'mocap_quarter': 100, 'mbientlab_50_p': 100, 'mbientlab_10_p': 100, 'mbientlab_50_r': 100,
                    'mbientlab_10_r': 25, 'mbientlab_quarter': 100, 'motionminers_real': 100, 'motionminers_flw': 200}}
    ...
    if usage_modus[usage_modus_idx] == 'train':
       folder_exp = '/data/sawasthi/mbientlab/model/'
       folder_exp_base_fine_tuning = '/data/sawasthi/mbientlab/model/network_LaraIMU_ci_100.pth' #model_acc_up4.pth #model_up1_3a.pt
       '''
    ...
    '''
       ...
       folder_exp = '/data/sawasthi/mbientlab/model/cad_LaraIMU_pose_ci_c1' + str(per_data) 
