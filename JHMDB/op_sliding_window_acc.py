...
if __name__ == '__main__':
    ...
    data_dir =  '/data/sawasthi/JHMDB/trainData_acc_up1_4s/'
    ...
    data_dir =  '/data/sawasthi/JHMDB/testData_acc_up1_4s/'
    ...
    data_dir =  '/data/sawasthi/JHMDB/validationData_acc_up1_4s/'
