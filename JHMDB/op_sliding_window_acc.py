...
if __name__ == '__main__':
    ...
    data_dir =  '/data/sawasthi/JHMDB/trainData_acc_up1_2s/'
    ...
    #data_dir = 'S:/MS A&R/4th Sem/Thesis/J-HMDB/joint_positions/train/pkl'
    data_dir =  '/data/sawasthi/JHMDB/testData_acc_up1_2s/'
    ...
    data_dir =  '/data/sawasthi/JHMDB/validationData_acc_up1_2s/'
