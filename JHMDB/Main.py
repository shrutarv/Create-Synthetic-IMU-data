...
if __name__ == '__main__':
    ...
    for iter in range(iterations):
        ...
        path = '/data/sawasthi/JHMDB/trainData_acc_up4_5s/' #trainData_pose_12
        ...
        # Validation data    
        path = '/data/sawasthi/JHMDB/validationData_acc_up4_5s/'
        ...
        path = '/data/sawasthi/JHMDB/testData_acc_up4_5s/'
