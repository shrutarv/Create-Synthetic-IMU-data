...
if __name__ == '__main__':
    ...
    config = {
        ...
        "reshape_input":False,
        "step_size":1,
        'model_complete': '/data/sawasthi/Penn/model/model_cnn_down2.pth'
        }
    ...
    for iter in range(iterations):
        ...
        model_path = '/data/sawasthi/Penn/model/model_acc_cnn_acc2_2s.pth'
        #model_path = 'S:/Datasets/Penn_Action/Penn_Action/model_test.pth'
        #model_path = 'S:/MS A&R/4th Sem/Thesis/PAMAP2_Dataset/'
       
        path = '/data/sawasthi/Penn/trainData_acc_acc2_2s/'
        ...
        # Validation data    
        path = '/data/sawasthi/Penn/validationData_acc_acc2_2s/'
        ...
        path = '/data/sawasthi/Penn/testData_acc_acc2_2s/'
