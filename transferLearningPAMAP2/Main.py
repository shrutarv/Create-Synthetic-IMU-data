...
if __name__ == '__main__':
    ...
    config = {
        ...
        "num_classes":16,
        "reshape_input":False,
        "folder_exp_base_fine_tuning": '/data/sawasthi/JHMDB/model/model_pose_tf.pth',
    ...
    for iter in range(iterations):
        ...
        '''
        model_path_tl = '/data/sawasthi/Penn/model/model_tl_J_PAMAP_new_pose_c1_c2_c3_c4_nf.pth'
