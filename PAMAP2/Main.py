...
if __name__ == '__main__':
    ...
    config = {
        ...
        "reshape_input":False,
        "dataset": "pamap2",
        "model_path": '/data/sawasthi/PAMAP2/model/model_new_cnn_30.pth'
        }
    ...
    for iter in range(iterations):
        ...
        model_path = '/data/sawasthi/PAMAP2/model/model_new_ci_50.pth'
        ...
        path = '/data/sawasthi/PAMAP2/trainData_50/'
