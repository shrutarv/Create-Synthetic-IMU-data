...
if __name__ == '__main__':
    ...
    data_dir =  "/data/sawasthi/data/Lara_IMU/testData_new/"
    ...
    for i,j in zip(FileList_x, FileList_y):
        ...
        data_y = pd.read_csv("/vol/actrec/DFG_Project/2019/LARa_dataset/Mbientlab/recordings_2019/06_IMU_annotated/S14/"+j)
        ...
        data_x = pd.read_csv("/vol/actrec/DFG_Project/2019/LARa_dataset/Mbientlab/recordings_2019/06_IMU_annotated/S14/"+i)
