...
if __name__ == '__main__':
    ...
    for iter in range(iterations):
        ...
        optimizer.zero_grad()
        path = '/data/sawasthi/Lara_motionminer/trainData_100/'
        ...
        # Validation data    
        path = '/data/sawasthi/Lara_motionminer/validationData_100/'
        #path = 'S:/MS A&R/4th Sem/Thesis/J-HMDB/joint_positions/train/pkl/'
        ...
        # Test data    
        path = '/data/sawasthi/Lara_motionminer/testData_100'
        #path = 'S:/MS A&R/4th Sem/Thesis/LaRa/IMU data/IMU data/Windows/'
        #path = "S:/MS A&R/4th Sem/Thesis/LaRa/OMoCap data/Test_data/"
        ...
        '''
        model_path_tl = '/data/sawasthi/Lara_motionminer/model/model_tl.pth'
