...
if __name__ == '__main__':
    ...
    config = {
        ...
        "num_classes":8,
        "reshape_input":False,
        "folder_exp_base_fine_tuning": '/data/sawasthi/CAD60/model/model_acc_cnn_up3_tf_2.pth'
    ...
    for prop in proportions_opts:
        ...
        for iter in range(iterations):
            ...
            '''
            path_tl = '/data/sawasthi/data/Lara_motionminer/model/model_ntu_laraIMU_acc_cnn_c1'+str(prop)+'.pth'
