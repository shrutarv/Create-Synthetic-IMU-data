...
if __name__ == '__main__':
    ...
    config = {
        ...
        "num_classes":8,
        "reshape_input":False,
        "folder_exp_base_fine_tuning": '/data/sawasthi/CAD60/model/model_acc_ci_up3_tf.pth', #'model_pose_tf.pth',model_acc_up3_tf
    ...
    for iter in range(iterations):
        ...
        optimizer.zero_grad()
        path = '/data/sawasthi/data/Lara_IMU/trainData_75/'
        ...
        '''
        model_path_tl = '/data/sawasthi/data/Lara_IMU/model/model_tl_CAD_laraimu_c1_75_acc_nf.pth'
