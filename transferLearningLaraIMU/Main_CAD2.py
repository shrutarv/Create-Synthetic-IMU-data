...
if __name__ == '__main__':
    ...
    config = {
        ...
        "num_classes":8,
        "reshape_input":False,
        "folder_exp_base_fine_tuning": '/data/sawasthi/CAD60/model/model_acc_cnn_up3_3s_tf.pth', #'model_pose_tf.pth',model_acc_up3_tf, model_acc_ci_up3_tf
    ...
    for prop in proportions_opts:
        ...
        for iter in range(iterations):
            ...
            '''
            model_path_tl = '/data/sawasthi/LaraIMU/model/model_tl_CAD_laraimu_cnn_30_acc_nf.pth'
