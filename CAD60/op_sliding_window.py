...
if __name__ == '__main__':   
   ...
   # df = pd.read_csv('S:/MS A&R/4th Sem/Thesis/CAD 60/train_data.csv')
    ...
    data_dir =  '/data/sawasthi/CAD60/trainData_acc_up1/'
    ...
    data_dir =  '/data/sawasthi/CAD60/testData_opp_acc_up1/'
    df = pd.read_csv('/data/sawasthi/CAD60/test_data.csv')
    data = df.values
    ...
    data_dir =  '/data/sawasthi/CAD60/validationData_opp_acc_up1/'
    data = df.values
