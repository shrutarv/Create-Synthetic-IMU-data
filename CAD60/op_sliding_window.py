...
if __name__ == '__main__':   
    ...
    data_dir =  '/data/sawasthi/CAD60/trainData_acc_up1_6s/'
    ...
    data_dir =  '/data/sawasthi/CAD60/testData_acc_up1_6s/'
    ...
    data_dir =  '/data/sawasthi/CAD60/validationData_acc_up1_6s/'
