...
if __name__ == '__main__':
    ...
    for iter in range(iterations):
        ...
        model_path = '/data/sawasthi/CAD60/model/model_acc_cnn_up1_4sec_tf.pth'
        model_path_2 = '/data/sawasthi/CAD60/model/model_acc_cnn_up1_4sec_tf_2.pth'
        #model_path = 'S:/MS A&R/4th Sem/Thesis/J-HMDB/joint_positions/train/pkl/'
        #model_path = 'S:/MS A&R/4th Sem/Thesis/PAMAP2_Dataset/'
       
        path = '/data/sawasthi/CAD60/trainData_acc_up1_4s/'
        ...
        # Validation data    
        path = '/data/sawasthi/CAD60/validationData_acc_up1_4s/'
        ...
        #testing(config)
        # Test data    
        path = '/data/sawasthi/CAD60/testData_acc_up1_4s/'
