...
if __name__ == '__main__':
    ...
    for iter in range(iterations):
        ...
        model_path = '/data/sawasthi/CAD60/model/model_acc_cnn_up3_5sec_tf.pth'
        ...
        path = '/data/sawasthi/CAD60/trainData_acc_up3_7s/'
        ...
        # Validation data    
        path = '/data/sawasthi/CAD60/validationData_acc_up3_7s/'
        ...
        #testing(config)
        # Test data    
        path = '/data/sawasthi/CAD60/testData_acc_up3_7s/'
        ...
        #testing(config)
        # Test data    
        path = '/data/sawasthi/CAD60/validationData_acc_up3validationData_acc_up3_6s_5s/'
        test_dataset = CustomDataSet(path)
