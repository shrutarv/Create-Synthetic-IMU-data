...
def validation(dataLoader_validation):
    ...
    print('\nvalidation set: test batch l{}\n'.format(test_batch_l[0]))  
    print('\nvalidation set: test batch l{}\n'.format(harwindow_batched["label"][0]))  
    print('output: l{}'.format(out)[0])
    print('output: l{}'.format(predicted_classes)[0])
...
if __name__ == '__main__':
    ...
    path = '/data/sawasthi/data/opportunity/trainData_loc/'
    ...
    # Validation data    
    path = '/data/sawasthi/data/opportunity/validationData_loc/'
    ...
    # Test data    
    path = '/data/sawasthi/data/opportunity/testData_loc/'
    #path = 'S:/MS A&R/4th Sem/Thesis/LaRa/IMU data/IMU data/Windows/'
    #path = "S:/MS A&R/4th Sem/Thesis/LaRa/OMoCap data/Test_data/"
